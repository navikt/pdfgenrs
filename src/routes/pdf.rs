...
mod tests {
    ...
    const SIMPLE_TEMPLATE: &str =
        "#set document(date: auto, title: \"Test\")\n#set page(margin: 1cm)\nHello!\n";
...
<body><h1>Hello</h1></body>
    ...
    async fn post_pdf_can_reference_image_from_resources_folder() -> anyhow::Result<()> {
        const TEMPLATE_WITH_IMAGE: &str = r#"#set document(date: auto, title: "Test")
#set page(margin: 1cm)
...
"#;
    ...
    async fn post_pdf_repeated_requests_do_not_grow_memory_unboundedly() -> anyhow::Result<()> {
        ...
        const TEMPLATE_WITH_JSON: &str = r#"#set document(date: auto, title: "Test")
#set page(margin: 1cm)
